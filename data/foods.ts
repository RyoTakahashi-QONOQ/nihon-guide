...
export const FOODS: Food[] = [
  {
    ...
    gallery: [
      { src: "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=800&q=75", alt: "Nigiri sushi platter", caption: "Edomae nigiri — each piece crafted by a master itamae" },
      { src: "https://images.unsplash.com/photo-1611143669185-af224c5e3252?w=800&q=75", alt: "Sushi counter omakase", caption: "Intimate omakase counter — the ultimate sushi experience" },
    ],
  },
  {
    ...
    gallery: [
      { src: "https://images.unsplash.com/photo-1557872943-16a5ac26437e?w=800&q=75", alt: "Tonkotsu ramen bowl", caption: "Rich tonkotsu ramen — slow-simmered pork bone broth with chashu" },
      { src: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=800&q=75", alt: "Miso ramen with toppings", caption: "Sapporo-style miso ramen with butter, corn, and bean sprouts" },
      { src: "https://images.unsplash.com/photo-1552611052-33e04de1b100?w=800&q=75", alt: "Ramen shop counter", caption: "A cosy ramen counter — Japan's quintessential dining experience" },
    ],
  },
  {
    ...
    gallery: [
      { src: "https://images.unsplash.com/photo-1535924571710-4c6e27716b6d?w=800&q=75", alt: "Assorted tempura platter", caption: "Seasonal tempura — prawns, shiso, lotus root, and more" },
      { src: "https://images.unsplash.com/photo-1519984388953-d2406bc725e1?w=800&q=75", alt: "Tempura being fried", caption: "The art of tempura — light, crisp batter cooked to perfection" },
    ],
  },
  {
    ...
    gallery: [
      { src: "https://images.unsplash.com/photo-1681270496598-13c5365730c8?w=800&q=75", alt: "Kaiseki course presentation", caption: "A kaiseki course — seasonal art on handcrafted ceramic" },
      { src: "https://images.unsplash.com/photo-1580822184713-fc5400e7fe10?w=800&q=75", alt: "Kaiseki dessert course", caption: "Wagashi dessert — the sweet finale of a kaiseki meal" },
    ],
  },
  {
    ...
    gallery: [
      { src: "https://images.unsplash.com/photo-1554797589-7241bb691548?w=800&q=75", alt: "Yakitori grilling", caption: "Yakitori over charcoal — the smoky heart of izakaya culture" },
      { src: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&q=75", alt: "Izakaya small plates", caption: "Shared small plates with beer — the izakaya experience" },
      { src: "https://images.unsplash.com/photo-1581473483413-12fb5869e36f?w=800&q=75", alt: "Tokyo yokocho alley", caption: "Atmospheric yokocho alley in Shinjuku" },
    ],
  },
];
