...
export const REGIONS: Region[] = [
  {
    ...
    desc: "Japan's northern frontier — a vast wilderness of powder snow, lavender fields, volcanic lakes and the freshest seafood in the country. Hokkaido offers a completely different Japan: wide open spaces, world-class skiing in Niseko and Furano, the vibrant city of Sapporo, and indigenous Ainu culture that predates recorded history.",
    highlights: ["Sapporo Snow Festival (February)", "Furano lavender fields (July)", "Niseko powder skiing", "Otaru canal district", "Shiretoko UNESCO wilderness", "Fresh uni, crab and seafood"],
    access: "2-hour flight from Tokyo Haneda to New Chitose Airport (Sapporo). Shinkansen from Tokyo to Shin-Hakodate-Hokuto in 4 hours.",
    bestSeason: "Winter for skiing & snow festivals, Summer for hiking & lavender"
  },
  {
